...
namespace Ayaya {
    ...
    static void SerializeEntity(YAML::Emitter& out, Entity entity, Scene* scene) {
        ...
        if (entity.HasComponent<PostProcessVolumeComponent>()) {
            ...
            out << YAML::Key << "SSRIntensity" << YAML::Value << ppv.SSRIntensity;
            ...
            out << YAML::Key << "SSRTemporalBlend" << YAML::Value << ppv.SSRTemporalBlend;
            out << YAML::EndMap;
        }
    ...
    bool SceneSerializer::Deserialize(const std::string& filepath, EditorState& outEditorState, std::function<void(float, const std::string&)> progressCallback) {
        ...
        for (auto entity : entities) {
            ...
            if (ppvComponent) {
                ...
                if (ppvComponent["SSRIntensity"]) ppv.SSRIntensity = ppvComponent["SSRIntensity"].as<float>();
                ...
                if (ppvComponent["SSRTemporalBlend"]) ppv.SSRTemporalBlend = ppvComponent["SSRTemporalBlend"].as<float>();
            }
